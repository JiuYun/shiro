package com.github.jiuyun.shiro.dao.impl;

import com.github.jiuyun.shiro.dao.UserDao;
...
public class UserDaoImpl implements UserDao{
    ...
    public User createUser(final User user) {
        ...
        jdbcTemplate.update(new PreparedStatementCreator() {
            ...
            public PreparedStatement createPreparedStatement(Connection connection) throws SQLException {
                ...
                int count = 1;
                psst.setLong(count++, user.getOrganizatinId());
    ...
    public User updateUser(User user) {
        ...
        jdbcTemplate.update(
                sql,
                user.getOrganizatinId(), user.getUsername(), user.getPassword(), user.getSalt(), user.getRoleIdsStr(), user.getLocked(), user.getId());
        return user;
    }
